...
const SearchBg = () => {
  ...
  return (
    <div className='flex items-center justify-center h-screen py-9' style={{ backgroundImage: `url(${backgroundUrl})`, backgroundSize: 'cover', backgroundPosition: 'center', transition: 'opacity 0.5s ease-in-out' }}>
        <div className="w-2/5 p-4 bg-white bg-opacity-85 border-2 rounded-lg">
        <h1 className='text-2xl mb-4 text-center'>Enter the place you want to explore:</h1>
